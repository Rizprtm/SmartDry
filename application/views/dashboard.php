            ...
            <div class="sidebar-wrapper active">
                <div class="sidebar-header">
                    <div class="d-flex justify-content-between">
                        <div class="logo">
                            <a href="index.html"><img src="<?php echo base_url('dashboardlaundry/dist/assets/images/logo/logo.png')?>" alt="Logo" srcset=""></a>
                        </div>
                        <div class="toggler">
                            ...
                            <div class="card-body py-4 px-5">
                                <div class="d-flex align-items-center">
                                    <div class="avatar avatar-xl">
                                        <img src="<?php echo base_url('dashboardlaundry/dist/assets/images/faces/1.jpg')?>" alt="Face 1">
                                    </div>
                                    <div class="ms-3 name">
                                        <h5 class="font-bold">Rizky Pratama</h5>
                                        <h6 class="text-muted mb-0">@rizkypratama.py</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
