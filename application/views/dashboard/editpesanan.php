                ...
                <section class="section">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                <form action = "<?php echo base_url ('C_Laundry/editpesanan') ?>" method ="post">
                                <?php foreach ($Laundry->result_array() as $key){?>
                                    <div class="form-group">
                                        <label for="disabledInput">Nama</label>
                                        <input type="text" name="nama" class="form-control" id="disabledInput" placeholder="Disabled Text" value="<?php echo $key['nama']?>" readonly>
                                    </div>
                                    ...
                                    <div class="form-check">
                                        ...
                                        <input type="text" class="form-control" id="helpInputTop" name="berat"  value="<?php echo $key['berat']?>" readonly>
                                    </div>
                                            <div class="form-group">
                                        <label for="basicInput">Alamat</label>
                                        <input type="text" name="alamat" class="form-control" id="disabledInput" value="<?php echo $key['alamat']?>" readonly>
                                    </div>
                                ...
                                <div class="form-group mb-3">
                                        ...
                                        <textarea class="form-control" id="exampleFormControlTextarea1" name="catatan"
                                            rows="3" value="<?php echo $key['catatan']?>"></textarea>
                                    </div>
                                    <div class="buttons">
